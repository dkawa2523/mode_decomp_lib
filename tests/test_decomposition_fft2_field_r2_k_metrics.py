...
def test_decomposition_fft2_emits_field_r2k_metrics(tmp_path: Path) -> None:
    ...
    cfg = {
        ...
        "decompose": {"name": "fft2", "disk_policy": "error"},
        "codec": {"name": "auto_codec_v1"},
        "offset_split": {"enabled": True, "f_offset": 5.0, "max_samples": n, "seed": 0},
